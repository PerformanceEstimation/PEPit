...
def wc_inexact_gradient(L, mu, epsilon, n, wrapper="cvxpy", verbose=1):
    """
    ...
    **References**:The detailed analyses can be found in [1, 2]. The logdet heuristic is presented in [3].
    ...
    Example:
        >>> pepit_tau, theoretical_tau = wc_inexact_gradient(L=1, mu=0.1, epsilon=0.1, n=6, wrapper="cvxpy", verbose=1)
