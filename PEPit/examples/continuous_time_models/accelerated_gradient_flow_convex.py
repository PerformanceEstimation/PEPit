...
def wc_accelerated_gradient_flow_convex(t, wrapper="cvxpy", verbose=1):
    """
    ...
    **References**:
    ...
    Example:
        >>> pepit_tau, theoretical_tau = wc_accelerated_gradient_flow_convex(t=3.4, wrapper="cvxpy", verbose=1)
