...
def wc_iipp(L, mu, c, lam, n, verbose=True):
    ...
    .. math:: F(x_n) - F(x_\\star) \\leqslant \\tau(\\mu,L,c,\\lambda,n)  (c D_h(x_\\star;x_0) + f(x_0) - f(x_\star))
    ...
    when :math:`c  D_h(x_\\star;x_0) + f_1(x_0) - f(x_\star)\\leqslant 1`.
    ...
    **Theoretical guarantee**: The following upper bound can be found in [1, Theorem 5.2]:
    ...
    .. math:: F(x_n) - F_\\star \\leqslant \\frac{4L}{c n^2}\\left( c  D_h(x_\\star;x_0) + f_1(x_0) - f(x_\\star) \\right).
