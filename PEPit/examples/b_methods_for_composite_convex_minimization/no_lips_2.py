...
def wc_no_lips2(L, gamma, n, verbose=True):
    ...
    .. math :: D_h(x_n, x_{n-1}) \\leqslant \\tau(n, L) D_h(x_0, x_\star),
    ...
    :math:`D_h(x_n, x_{n-1})` when :math:`D_h(x0, x_\star) \\leqslant 1`.
    ...
    **Theoretical guarantee**:
    ...
    Example:
        ...
        *** Example file: worst-case performance of the NoLips_2 in Bregman distance ***
            PEP-it guarantee:	 min_n Dh(x_n, x_(n-1)) <= 0.0221588 Dh(x_0, x_*)
            Theoretical guarantee :	 min_n Dh(x_n, x_(n-1)) <= 0.0222222 Dh(x_0, x_*)
    ...
    if verbose:
        ...
        print('\tPEP-it guarantee:\t min_n Dh(x_n, x_(n-1)) <= {:.6} Dh(x_0, x_*)'.format(pepit_tau))
        print('\tTheoretical guarantee :\t min_n Dh(x_n, x_(n-1)) <= {:.6} Dh(x_0, x_*) '.format(theoretical_tau))
