...
def wc_polyak_steps_in_distance_to_optimum(L, mu, gamma, wrapper="cvxpy", verbose=1):
    """
    ...
    **References**:
    ...
    Example:
        ...
        >>> mu = 0.1
        >>> gamma = 2 / (L + mu)
        >>> pepit_tau, theoretical_tau = wc_polyak_steps_in_distance_to_optimum(L=L, mu=mu, gamma=gamma, wrapper="cvxpy", verbose=1)
