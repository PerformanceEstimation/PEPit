...
def wc_gradient_descent_quadratic_lojasiewicz_naive(L, mu, gamma, n, wrapper="cvxpy", solver=None, verbose=1):
    """
...
if __name__ == "__main__":
    L, mu, gamma, n = 1, .2, 1, 1
    pepit_tau, theoretical_tau = wc_gradient_descent_quadratic_lojasiewicz_naive(L=L, mu=mu, gamma=gamma, n=n,
