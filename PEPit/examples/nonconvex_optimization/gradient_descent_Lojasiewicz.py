...
def wc_gradient_descent_naiveLojaciewicz(L, mu, gamma, n, wrapper="cvxpy", solver=None, verbose=1):
    ...
    **References**:
	...
	(PEPit) Solver status: optimal (wrapper:cvxpy, solver: MOSEK); optimal value: 0.9046481165374973
	(PEPit) Primal feasibility check:
			The solver found a Gram matrix that is positive semi-definite
			All the primal scalar constraints are verified
	(PEPit) Dual feasibility check:
			The solver found a residual matrix that is positive semi-definite
			All the dual scalar values associated with inequality constraints are nonnegative up to an error of 1.9683576634493627e-08
	(PEPit) The worst-case guarantee proof is perfectly reconstituted up to an error of 1.0815777574037379e-07
	(PEPit) Final upper bound (dual): 0.904648116197709 and lower bound (primal example): 0.9046481165374973 
	(PEPit) Duality gap: absolute: -3.397883086009301e-10 and relative: -3.756027370083471e-10
