...
from .optimistic_gradient_refined import wc_optimistic_gradient_refined
from .optimistic_gradient_refined_cocoercive import wc_optimistic_gradient_refined_cocoercive
...
__all__ = ['accelerated_proximal_point', 'wc_accelerated_proximal_point',
           ...
           'optimistic_gradient_refined', 'wc_optimistic_gradient_refined',
           'optimistic_gradient_refined_cocoercive', 'wc_optimistic_gradient_refined_cocoercive',
