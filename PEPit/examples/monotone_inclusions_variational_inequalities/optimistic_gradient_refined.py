...
def wc_optimistic_gradient_refined(n, gamma, L, wrapper="cvxpy", solver=None, verbose=1):
    """
    ...
    **References**:
    ...
    F = problem.declare_function(LipschitzStronglyMonotoneOperatorExpensive, mu=0, L=L)
