...
class CocoerciveStronglyMonotoneOperatorExpensive(Function):
    """
    The :class:`CocoerciveStronglyMonotoneOperatorExpensive` class overwrites the `add_class_constraints` method
    ...
    Example:
        ...
        >>> problem = PEP()
        >>> func = problem.declare_function(function_class=CocoerciveStronglyMonotoneOperatorExpensive, mu=.1, beta=1.)
        ...
        for i, point_i in enumerate(self.list_of_points):
            ...
            for j, point_j in enumerate(self.list_of_points):
                ...
                for k, point_k in enumerate(self.list_of_points):
                    ...
                    if not (point_i == point_j == point_k):
