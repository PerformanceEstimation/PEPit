...
class SmoothConvexQGFunction(Function):
    """
    ...
    def add_class_constraints(self):
        ...
        list_of_non_stationary_points = []
        for point in self.list_of_points:
            if point not in self.list_of_stationary_points:
                list_of_non_stationary_points.append(point)
        self.add_constraints_from_two_lists_of_points(list_of_points_1=self.list_of_points,
                                                      list_of_points_2=list_of_non_stationary_points,
