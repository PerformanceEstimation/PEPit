...
class TestExamples(unittest.TestCase):
    ...
    def test_OGM(self):
        L, n = 3, 4
        wc, theory = OGM.wc_ogm(L, n, verbose=False)
    ...
    def test_els(self):
        ...
        wc, theory = ELS.wc_els(L=L, mu=mu, n=n, verbose=False)
    ...
    def test_subgd(self):
        ...
        wc, theory = SG.wc_subgd(M=M, N=N, gamma=gamma, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_cg(self):
        ...
        wc, theory = CG.wc_CG(L=L, n=n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_inexact_els(self):
        ...
        wc, theory = inELS.wc_InexactGrad_ELS(L=L, mu=mu, epsilon=epsilon, n=n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_inexact_grad(self):
        ...
        wc, theory = inGD.wc_InexactGrad(L=L, mu=mu, epsilon=epsilon, n=n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)

    def test_inexact_agm(self):

        L, epsilon, n = 3, 0, 5
        wc, theory = inAGM.wc_InexactAGM(L=L, epsilon=epsilon, n=n, verbose=False)
    ...
    def test_hbm(self):
        ...
        wc, theory = inHBM.wc_heavyball(mu=mu, L=L, alpha=alpha, beta=beta, n=n, verbose=False)
    ...
    def test_fppa(self):
        ...
        wc, theory = inFPM.wc_fppa(A0=A0, gammas=gammas, n=n, verbose=False)
        self.assertLessEqual(wc,theory*(1+10**-3))
    ...
    def test_tmm(self):
        ...
        wc, theory = inTMM.wc_tmm(mu=mu, L=L, n=n, verbose=False)
        self.assertAlmostEqual(theory, wc, delta=10 ** -3 * theory)
    ...
    def test_rmm(self):
        ...
        # Compare theoretical rate in epsilon=0 case
        wc, theory = inRMM.wc_rmm(mu=mu, L=L, lam=lam, verbose=False)
        self.assertAlmostEqual(theory, wc, delta=10 ** -3 * theory)
    ...
    def test_infgm(self):
        ...
        wc, theory = inFGM.wc_fgm(mu, L, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_instr_fgm(self):
        ...
        wc, theory = instrFGM.wc_fgm(mu=mu, L=L, n=n, verbose=False)
    ...
    def test_inbppm(self):
        ...
        wc, theory = inBPPM.wc_bpp(gamma=gamma, n=n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_incgfw(self):
        ...
        wc, theory = inCGFW.wc_cg_fw(L, D, n, verbose=False)
        self.assertLessEqual(wc, theory)
    ...
    def test_indrs1(self):
        ...
        wc, theory = inDRS1.wc_drs(mu, L, alpha, theta, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_indrs2(self):
        ...
        wc, theory = inDRS2.wc_drs_2(L, alpha, theta, n, verbose=False)
        self.assertLessEqual(wc, theory)
    ...
    def test_iniia(self):
        ...
        wc, theory = inIIA.wc_iipp(L, mu, c, lam, n, verbose=False)
        self.assertLessEqual(wc, theory)
    ...
    def test_innl1(self):
        ...
        wc, theory = inNL1.wc_no_lips1(L, gamma, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_innl2(self):
        ...
        wc, theory = inNL2.wc_no_lips2(L, gamma, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_ncgd(self):
        ...
        wc, theory = ncGD.wc_gd(L, gamma, n, verbose=False)
        self.assertLessEqual(wc, theory)
    ...
    def test_ncnl1(self):
        ...
        wc, theory = ncNL1.wc_no_lips1(L, gamma, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_ncnl2(self):
        ...
        wc, theory = ncNL2.wc_no_lips2(L, gamma, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_insaga(self):
        ...
        wc, theory = inSAGA.wc_saga(L, mu, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_insgdsc(self):
        ...
        wc, theory = inSGDSC.wc_sgd(L, mu, gamma, v, R, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_insgd(self):
        ...
        wc, theory = inSGD.wc_sgdo(L, mu, gamma, R, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_opapp(self):
        ...
        wc, theory = opAPP.wc_ppm(alpha, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_opppm(self):
        ...
        wc, theory = opPPM.wc_ppm(alpha, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_inhi(self):
        ...
        wc, theory = inHI.wc_halpern(L, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)

    def test_inkm(self):
        L, n = 1, 10

        wc, theory = inKM.wc_km(L, n, verbose=False)
        self.assertLessEqual(wc, theory)
    ...
    def test_potgd1(self):
        ...
        wc, theory = potGD1.wc_gd_lyapunov_1(L, gamma, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_potgd2(self):
        ...
        wc, theory = potGD2.wc_gd_lyapunov_2(L, gamma, n, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_potfgd(self):
        ...
        wc, theory = potFGD.wc_gd_lyapunov(L, gamma, lam, verbose=False)
        self.assertAlmostEqual(wc, theory, delta=10 ** -3 * theory)
    ...
    def test_inps1(self):
        ...
        wc, theory = inPS1.wc_ps_1(L, mu, gamma, verbose=False)
    ...
    def test_inps2(self):
        ...
        wc, theory = inPS2.wc_ps_2(L, mu, gamma, verbose=False)
        self.assertLessEqual(wc, theory+10**-3)
