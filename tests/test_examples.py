...
import examples.a_methods_for_unconstrained_convex_minimization.conjugate_gradient_method as CG
import examples.a_methods_for_unconstrained_convex_minimization.fast_gradient_method as inFGM
import examples.a_methods_for_unconstrained_convex_minimization.fast_gradient_method_strongly_convex as instrFGM
import examples.a_methods_for_unconstrained_convex_minimization.fast_proximal_point as inFPM
import examples.a_methods_for_unconstrained_convex_minimization.gradient_exact_line_search as ELS
import examples.a_methods_for_unconstrained_convex_minimization.heavy_ball_method as inHBM
import examples.a_methods_for_unconstrained_convex_minimization.inexact_accelerated_gradient as inAGM
import examples.a_methods_for_unconstrained_convex_minimization.inexact_gradient_descent as inGD
import examples.a_methods_for_unconstrained_convex_minimization.inexact_gradient_exact_line_search as inELS
import examples.a_methods_for_unconstrained_convex_minimization.optimized_gradient_method as OGM
import examples.a_methods_for_unconstrained_convex_minimization.robust_momentum_method as inRMM
import examples.a_methods_for_unconstrained_convex_minimization.subgradient_method as SG
import examples.a_methods_for_unconstrained_convex_minimization.triple_momentum_method as inTMM
import examples.b_methods_for_composite_convex_minimization.accelerated_douglas_rachford_splitting as inADGS
import examples.b_methods_for_composite_convex_minimization.bregman_proximal_point_method as inBPPM
import examples.b_methods_for_composite_convex_minimization.conditional_gradient_frank_wolfe as inCGFW
import examples.b_methods_for_composite_convex_minimization.douglas_rachford_splitting_1 as inDRS1
import examples.b_methods_for_composite_convex_minimization.douglas_rachford_splitting_2 as inDRS2
import examples.b_methods_for_composite_convex_minimization.fast_proximal_gradient_method as inFPGM
import examples.b_methods_for_composite_convex_minimization.improved_interior_algorithm as inIIA
import examples.b_methods_for_composite_convex_minimization.no_lips_1 as inNL1
import examples.b_methods_for_composite_convex_minimization.no_lips_2 as inNL2
import examples.b_methods_for_composite_convex_minimization.three_operator_splitting as inTOS
import examples.c_methods_for_nonconvex_optimization.gradient_method as ncGD
import examples.c_methods_for_nonconvex_optimization.no_lips_1 as ncNL1
import examples.c_methods_for_nonconvex_optimization.no_lips_2 as ncNL2
import examples.d_stochastic_methods_for_convex_minimization.SAGA as inSAGA
import examples.d_stochastic_methods_for_convex_minimization.SGD_overparametrized as inSGD
import examples.d_stochastic_methods_for_convex_minimization.SGD_strongly_convex as inSGDSC
import examples.e_monotone_inclusions.accelerated_proximal_point as opAPP
import examples.e_monotone_inclusions.douglas_rachford_splitting as opDRS
import examples.e_monotone_inclusions.proximal_point_method as opPPM
import examples.e_monotone_inclusions.three_operator_splitting as opTOS
import examples.f_fixed_point_iterations.halpern_iteration as inHI
import examples.f_fixed_point_iterations.krasnoselskii_mann as inKM
import examples.g_verify_potential_functions.fast_gradient_descent as potFGD
import examples.g_verify_potential_functions.gradient_descent_1 as potGD1
import examples.g_verify_potential_functions.gradient_descent_2 as potGD2
import examples.i_adaptive_methods.polyak_steps_1 as inPS1
import examples.i_adaptive_methods.polyak_steps_2 as inPS2
import examples.j_low_dimensional_worst_cases_scenarios.inexact_gradient as inLDIGD
import examples.j_low_dimensional_worst_cases_scenarios.optimized_gradient_method as inLDOGM
import examples.h_inexact_proximal_methods.accelerated_hybrid_proximal_extra_gradient as inAHPE
import examples.h_inexact_proximal_methods.accelerated_inexact_forward_backward as inAIFB
import examples.h_inexact_proximal_methods.optimized_relatively_inexact_proximal_point_algorithm as inORIPPA
import examples.h_inexact_proximal_methods.partially_inexact_douglas_rachford_splitting as inPIDRS
import examples.h_inexact_proximal_methods.relatively_inexact_proximal_point_algorithm_1 as inRIPP_1
import examples.h_inexact_proximal_methods.relatively_inexact_proximal_point_algorithm_2 as inRIPP_2
