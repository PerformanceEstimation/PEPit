...
from PEPit.Operator_classes.LipschitzStronglyMonotone import LipschitzStronglyMonotoneOperator
from PEPit.Operator_classes.StronglyMonotone import StronglyMonotoneOperator
