...
def wc_tos(mu, L1, L3, alpha, theta, n, verbose=True):
    """
     Consider the composite convex minimization problem,
        min_x { F(x) = f_1(x) + f_2(x) + f_3(x)}
    where f_1 is L-smooth and mu-strongly convex, f_2 is closed, convex
    and proper, and f_3 is smooth convex. Proximal operators are assumed to be available for f_1 and f_2.
    ...
    # Compute n steps of the Three Operator Splitting starting from x0
    w = x0
    for _ in range(n):
...
if __name__ == "__main__":
    ...
    pepit_tau, theoretical_tau = wc_tos(mu=mu,
                    L1=L1,
                    L3=L3,
                    alpha=alpha,
                    theta=theta,
